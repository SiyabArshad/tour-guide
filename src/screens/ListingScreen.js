...
{/**snady part */}
                            <View style={{width:"100%",padding:10,borderRadius:5,backgroundColor:"lightgrey",marginBottom:10}}>
                                <Text style={{fontSize:16,color:"grey",fontWeight:"bold"}}>Sandy says</Text>
...
{/**end sandy part */}             
                        ...
                        <View style={{width:"100%",padding:10,marginBottom:10,borderRadius:5,display:"flex",
                        flexDirection:"row",justifyContent:"space-between",backgroundColor:"lightgrey"}}>
                                <Text style={{fontSize:16,color:"grey",fontWeight:"bold"}}>Views</Text>
                                <Text style={{fontSize:16,color:apColors.pText}}>{viewCount}</Text>
                        </View>
                        <View style={{width:"100%",padding:10,borderRadius:5,marginBottom:10,backgroundColor:"lightgrey"}}>
                                <Text style={{fontSize:16,color:"grey",fontWeight:"bold"}}>Available</Text>
                                <Text style={{fontSize:16,color:apColors.pText}}>{availability?"Yes":"No"}</Text>
                        </View>

                        <View style={{width:"100%",padding:10,borderRadius:5,marginBottom:10,backgroundColor:"lightgrey"}}>
                                <Text style={{fontSize:16,color:"grey",fontWeight:"bold"}}>Location</Text>
                                <Text style={{fontSize:16,color:apColors.pText}}>{title}{" is located at "}{address}</Text>
                        </View>
